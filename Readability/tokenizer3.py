...
import string
import re
from pickling3 import unpkl_2layered_s
...
class Tokenizer(object):
    ...
    def __init__(self):
        ...
        Initialize
        """
        self.abbrs = unpkl_2layered_s(os.path.join(os.path.dirname(sys.argv[0]), "C:\\Users\\ivanetsas\\PycharmProjects\\Readability\\Readability\\dicts\\abbr.pkl"))
        ...
        self.regexp = re.compile(r'''
          ...
          (?:[{1}]) |                                                       # punctuation
          (?:.)                                                             # all the rest
        '''.format(r"|".join([r"(?:" + x + r")(?!\w)" for x in self.abbrs.keys()]), string.punctuation + "№«»…‰"),
